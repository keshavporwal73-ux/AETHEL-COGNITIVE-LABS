...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-e84qhhad10xt-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand` |
| Query Task (Single) Endpoint | `GET https://app-e84qhhad10xt-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
| Query Task (List) Endpoint | `GET https://app-e84qhhad10xt-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
