...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-e84qhhad10xt-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-e84qhhad10xt-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
    {
      method: "POST",
      headers: {
