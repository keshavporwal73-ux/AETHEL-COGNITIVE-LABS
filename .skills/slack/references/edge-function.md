...
const actions = {
  ...
  find_channels: {
    url: "https://app-e84qhhad10xt-api-connect-slack-find-channels.gateway.appmedo.com/",
    callers: "public",
  },
  // Free-text search across the workspace; there is no target to pin.
  search_messages: {
    url: "https://app-e84qhhad10xt-api-connect-slack-search-messages.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_channel_history: {
    url: "https://app-e84qhhad10xt-api-connect-slack-get-channel-history.gateway.appmedo.com/",
    callers: "authenticated",
  },
  send_message: {
    url: "https://app-e84qhhad10xt-api-connect-slack-send-message.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
