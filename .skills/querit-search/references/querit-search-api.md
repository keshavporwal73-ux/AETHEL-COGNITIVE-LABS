...
Gateway marker host uses Traefik rewrite: `api-w9Rb5Jdedqq9@app-e84qhhad10xt-api-w9Rb5Jdedqq9.gateway.appmedo.com` → `{app_id}-api-w9Rb5Jdedqq9{gateway_suffix}`.

## Endpoint Information

| Item | Value |
|------|-------|
| Endpoint | `POST https://app-e84qhhad10xt-api-w9Rb5Jdedqq9.gateway.appmedo.com/v1/search` |
...
export async function callQueritSearch(
  ...
  const response = await fetch(
    "https://app-e84qhhad10xt-api-w9Rb5Jdedqq9.gateway.appmedo.com/v1/search",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
