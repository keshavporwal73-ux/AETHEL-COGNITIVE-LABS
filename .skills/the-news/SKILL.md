...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-e84qhhad10xt-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-e84qhhad10xt-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-e84qhhad10xt-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-e84qhhad10xt-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-e84qhhad10xt-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-e84qhhad10xt-api-wL1zlEdVM6DY.gateway.appmedo.com`
