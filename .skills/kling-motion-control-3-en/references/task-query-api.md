...
```http
GET https://app-e84qhhad10xt-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks?task_ids=TASK_ID
GET https://app-e84qhhad10xt-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks?external_task_ids=EXTERNAL_ID
